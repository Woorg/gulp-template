!(function () {
      ...
      499: function () {
        ;((A, e) => {
          var n,
            ...
            a = {
              ...
              addTest: function (A, e, n) {
                o.push({ name: A, fn: e, options: n })
              },
              addAsyncTest: function (A) {
                o.push({ name: null, fn: A })
              },
            },
            s = function () {},
            i = ((s.prototype = a), (s = new s()), [])
          function r(A, e) {
            return typeof A === e
          }
          n =
            void 0 !== (t = {}.hasOwnProperty) && void 0 !== t.call
              ? function (A, e) {
                  return t.call(A, e)
                }
              : function (A, e) {
          ...
          var l,
            ...
            g,
            h = e.documentElement,
            w = 'svg' === h.nodeName.toLowerCase()
          function m(A, e) {
            if ('object' == typeof A) for (var t in A) n(A, t) && m(t, A[t])
            else {
              var o = (A = A.toLowerCase()).split('.'),
                a = s[o[0]]
              if (void 0 !== (a = 2 === o.length ? a[o[1]] : a)) return s
              ;((e = 'function' == typeof e ? e() : e),
                1 === o.length
                  ? (s[o[0]] = e)
                  : (!s[o[0]] || s[o[0]] instanceof Boolean || (s[o[0]] = new Boolean(s[o[0]])), (s[o[0]][o[1]] = e)),
                (a = [(e && !1 !== e ? '' : 'no-') + o.join('-')]),
                (o = h.className),
                (r = s._config.classPrefix || ''),
                w && (o = o.baseVal),
                s._config.enableJSClass &&
                  ((i = new RegExp('(^|\\s)' + r + 'no-js(\\s|$)')), (o = o.replace(i, '$1' + r + 'js$2'))),
                s._config.enableClasses &&
                  (0 < a.length && (o += ' ' + r + a.join(' ' + r)), w ? (h.className.baseVal = o) : (h.className = o)),
                s._trigger(A, e))
            }
            var i, r
            return s
          ...
          s.addAsyncTest(function () {
            ...
            function n(A, e, n) {
              ...
              function o(e) {
                ...
                ;(m(A, 'webp' === A && o ? new Boolean(o) : o), n && n(e))
              }
              ;((t.onerror = o), (t.onload = o), (t.src = e))
            }
            n(e.name, e.uri, function (e) {
              if (e && 'load' === e.type) for (var t = 0; t < A.length; t++) n(A[t].name, A[t].uri)
            })
          }),
          s.addAsyncTest(function () {
            var A = new Image()
          ...
          o))
            if (o.hasOwnProperty(g)) {
              if (
                ((l = []),
                (c = o[g]).name &&
                  (l.push(c.name.toLowerCase()), c.options) &&
                  c.options.aliases &&
                  c.options.aliases.length)
              )
                for (u = 0; u < c.options.aliases.length; u++) l.push(c.options.aliases[u].toLowerCase())
              for (f = r(c.fn, 'function') ? c.fn() : c.fn, p = 0; p < l.length; p++)
                (1 === (d = l[p].split('.')).length
                  ? (s[d[0]] = f)
                  : ((s[d[0]] && (s[d[0]], s[d[0]] instanceof Boolean)) || (s[d[0]] = new Boolean(s[d[0]])),
                    (s[d[0]][d[1]] = f)),
                  i.push((f ? '' : 'no-') + d.join('-')))
            }
          ;(delete a.addTest, delete a.addAsyncTest)
          for (var B = 0; B < s._q.length; B++) s._q[B]()
          A.Modernizr = s
  ...
  function n(t) {
    ...
    var a = (e[t] = { exports: {} })
    return (A[t](a, a.exports, n), a.exports)
  }
  !(function () {
    'use strict'
    n(499)
    class A {
      getProxyState(A) {
        return new Proxy(A, {
          ...
          set: (A, e, n) => {
            const t = A[e]
            return ((A[e] = n), n !== t && this.updateUI(), !0)
          },
        })
      }
      updateUI() {
    ...
    new (class extends A {
      constructor() {
        ;(super(), this.init(), this.bindEvents())
      }
      init() {}
      bindEvents() {}
    })()
